...
Es importante aclarar que el c/'alculo del \textit{score} de cada variable no se hace tal cual dicta DLIS, pues en aras de mantener lo m/' con la implementaci/'on 
